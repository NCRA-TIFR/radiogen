...
catalog = pd.read_csv('TGSSADR_R05D45_5x5.MOSAIC.pybdsm.srl', skiprows=6, names=header)
data = fits.open('TGSSADR_R05D45_5x5.MOSAIC.pybdsm_gaus_model.fits')[0].data[0][0]
w = wcs.WCS('TGSSADR_R05D45_5x5.MOSAIC.pybdsm_gaus_model.fits')
